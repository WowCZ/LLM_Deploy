...
class ChineseAlpacaAPI(LLMAPI):
    ...
    def _download_adapter(self, adapter_name: str, adapter_path: str):
        if not os.path.exists(adapter_path):
            ...
            tokenizer = LlamaTokenizer.from_pretrained(adapter_name)
    ...
    def _initialize_llm(self):
        tokenizer = LlamaTokenizer.from_pretrained(self.adapter_name, padding_side='left')
    ...
    def generate(self, item:BaseModel) -> List[str]:
        ...
        instance = [CHINESE_ALPACA_PROMPT.format(instruction=ins) for ins in instance]
